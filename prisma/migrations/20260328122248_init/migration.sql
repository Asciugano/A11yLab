-- CreateEnum
CREATE TYPE "LessonType" AS ENUM ('DOCUMENT', 'VIDEO');

-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('USER', 'CREATOR', 'ADMIN');

-- CreateEnum
CREATE TYPE "Subcription" AS ENUM ('FREE', 'PLUS');
...
CREATE TABLE "User" (
    ...
    "subcription" "Subcription" NOT NULL DEFAULT 'FREE',
...
CREATE TABLE "Course" (
    ...
    "title" TEXT NOT NULL,
    "description" TEXT NOT NULL,
    "subscription" "Subcription" NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- AddForeignKey
ALTER TABLE "CertificateTemplate" ADD CONSTRAINT "CertificateTemplate_courseId_fkey" FOREIGN KEY ("courseId") REFERENCES "Course"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
